...
class DiffusionPolicyConfig(BaseConfig):
    ...
    def algo_config(self):
        ...
        self.algo.optim_params.policy.learning_rate.scheduler_type = "linear"       # type of learning rate scheduler to use
        self.algo.optim_params.policy.regularization.L2 = 0.00                      # L2 regularization strength
        self.algo.optim_params.policy.optimizer_type = "adamw"                      # type of optimizer to use

        # horizon parameters
        self.algo.horizon.observation_horizon = 2
        self.algo.horizon.observation_horizon_stride_human = 1                      # When co-training, this is used to stride the human horizon. Because human data are typically faster than robot data, we need to stride the observation horizon of human data to match the robot horizon.
